...
--DROP TABLE PRESENTER_OWNER.STAFF_PRESENTATION CASCADE CONSTRAINTS PURGE;
...
--DROP TABLE PRESENTER_OWNER.TITLE_SLIDE CASCADE CONSTRAINTS PURGE;
--DROP TABLE PRESENTER_OWNER.DATE_SLIDE CASCADE CONSTRAINTS PURGE;
...
CREATE TABLE PRESENTER_OWNER.DATE_SLIDE
(
    SLIDE_ID             INTEGER NOT NULL ,
    ...
    CONSTRAINT DATE_SLIDE_FK1 FOREIGN KEY (SLIDE_ID) REFERENCES PRESENTER_OWNER.SLIDE (SLIDE_ID) ON DELETE CASCADE
);

CREATE TABLE PRESENTER_OWNER.TITLE_SLIDE
(
    TITLE                VARCHAR2(128) NULL ,
    SLIDE_ID             INTEGER NOT NULL ,
    CONSTRAINT TITLE_SLIDE_PK PRIMARY KEY (SLIDE_ID),
    CONSTRAINT TITLE_SLIDE_FK1 FOREIGN KEY (SLIDE_ID) REFERENCES PRESENTER_OWNER.SLIDE (SLIDE_ID) ON DELETE CASCADE
);
...
CREATE TABLE PRESENTER_OWNER.STAFF_PRESENTATION
(
    PRESENTATION_ID      INTEGER NOT NULL ,
    TITLE                VARCHAR2(128) NULL ,
    STAFF_ID             INTEGER NULL ,
    CONSTRAINT STAFF_PRESENTATION_PK PRIMARY KEY (PRESENTATION_ID),
    CONSTRAINT STAFF_PRESENTATION_AK1 UNIQUE (TITLE,STAFF_ID),
    CONSTRAINT STAFF_PRESENTATION_FK1 FOREIGN KEY (PRESENTATION_ID) REFERENCES PRESENTER_OWNER.PRESENTATION (PRESENTATION_ID) ON DELETE CASCADE
);
