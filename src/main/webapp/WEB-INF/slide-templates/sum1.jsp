...
<div class="slide ${slide.syncFromSlideId ne null ? 'synced-slide' : ''}" data-slideid="${fn:escapeXml(slide.slideId)}" data-type="${slide.slideType}" data-subtype="${slide.pdInfoSlideType}" data-sync-presentationid="${slide.syncFromPresentationId}">
