...
public class Slide implements Serializable {
    ...
    @Transient
    private BigInteger syncFromPresentationId;
    @Transient
    private PresentationType syncFromPresentationType;
    ...
    public String toString(){
        return "Order: " + orderId + ", Type: " + slideType.name() + ", Label: " + label + ", Presentation ID: " + presentation.getPresentationId() + ", Slide ID: " + slideId;
    }
}
