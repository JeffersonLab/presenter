...
public abstract class ShowInfo {
    ...
    protected List<Slide> generalTemplates = Arrays.asList(new TitleBodySlide(),
    ...
    public static ShowInfo getShowInfo(Presentation presentation, boolean editable,
            String logbookHostname) {
        ShowInfo info = null;
        ...
        switch (presentation.getPresentationType()) {
            ...
            case UITF_PRESENTATION:
                ...
                break;
            default:
                throw new RuntimeException("Presentation type not recognized: "
...
class PDShowInfo extends ShowInfo {
    ...
    public PDShowInfo(PDPresentation presentation) {
        ...
        switch (presentation.getPdPresentationType()) {
            case RUN:
                templates.add(new ShiftInfoSlide(TimeUtil.getLSDContentDate(
                        presentation.getDeliveryYmd()), Shift.DAY, ShiftSlideType.PD));
 ...
 /*try {
            ...
            case LSD:
                templates.add(new ShiftInfoSlide(TimeUtil.getLSDContentDate(
                        presentation.getDeliveryYmd()), Shift.DAY));
                templates.add(UrlUtil.getWorkmapSlide(presentation.getDeliveryYmd()));
                templates.add(UrlUtil.getCalendarSlide(presentation.getDeliveryYmd()));
                templates.addAll(generalTemplates);
                break;
            case HCO:
                templates.add(new ShiftInfoSlide(TimeUtil.getLSDContentDate(
                        presentation.getDeliveryYmd()), Shift.DAY, ShiftSlideType.HCO));
                templates.add(UrlUtil.getWorkmapSlide(presentation.getDeliveryYmd()));
                templates.add(UrlUtil.getCalendarSlide(presentation.getDeliveryYmd()));
                templates.add(UrlUtil.getDailyFsdSlide(presentation.getDeliveryYmd()));                
            ...
            case SUM1:
                ...
                templates.add(new PdInfoSlide(PdInfoSlideType.FIRST_SUMMARY,
                        presentation.getDeliveryYmd(), TimeUtil.getOneWeekLater(
            ...
            case SUM2:
                templates.add(new BodySlide(BodySlideType.PD_SUMMARY_OVERFLOW));
                templates.add(new PdInfoSlide(PdInfoSlideType.SECOND_SUMMARY,
