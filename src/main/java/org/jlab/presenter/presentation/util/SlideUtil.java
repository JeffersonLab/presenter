...
public class SlideUtil {
  ...
  public static void update(HttpServletRequest request, TitleBodySlide titleBodySlide) {
    ...
    TitleBodySlideType titleBodySlideType =
        ConvertAndValidateUtil.convertAndValidateTitleBodySlideTypeParam(request, "slideSubType");
  ...
  public static void update(HttpServletRequest request, BodySlide bodySlide) {
    String body = request.getParameter("body");
    BodySlideType bodySlideType =
        ConvertAndValidateUtil.convertAndValidateBodySlideTypeParam(request, "slideSubType");
  ...
  public static void update(HttpServletRequest request, ShiftInfoSlide shiftInfoSlide)
      throws ParseException {
    ShiftSlideType shiftSlideType =
        ConvertAndValidateUtil.convertAndValidatePdShiftSlideTypeParam(request, "slideSubType");
  ...
  public static void update(HttpServletRequest request, BtaShiftInfoSlide btaShiftInfoSlide)
      throws ParseException {
    SlideUtil.update(request, (ShiftInfoSlide) btaShiftInfoSlide);
    List<BtaRecord> btaRecords =
        ConvertAndValidateUtil.convertAndValidateBtaRecordParams(request, btaShiftInfoSlide);

    btaShiftInfoSlide.setBtaRecordList(btaRecords);
  }

  public static void update(HttpServletRequest request, PdInfoSlide pdInfoSlide)
      throws ParseException {
    String body = request.getParameter("body");
  ...
  public static void update(HttpServletRequest request, PdBeamAccSlide pdBeamAccSlide) {
    List<BeamToHallRecord> beamRecords =
        ConvertAndValidateUtil.convertAndValidateBeamToHallRecordParams(request, pdBeamAccSlide);
    List<AccActivityRecord> accRecords =
        ConvertAndValidateUtil.convertAndValidateAccActivityRecordParams(request, pdBeamAccSlide);
  ...
  public static void update(HttpServletRequest request, PdAccessSlide pdAccessSlide) {
    ...
    List<AccessRecord> accessRecords =
        ConvertAndValidateUtil.convertAndValidateAccessRecordParams(request, pdAccessSlide);
