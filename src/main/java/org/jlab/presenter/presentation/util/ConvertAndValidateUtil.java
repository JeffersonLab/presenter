...
public class ConvertAndValidateUtil {
    ...
    public static Boolean convertYNBoolean(HttpServletRequest request, String name) throws
    ...
    public static Long convertAndValidateLongParam(HttpServletRequest request, 
    ...
    public static Date convertAndValidateYMDParam(HttpServletRequest request, 
    ...
    public static Date convertAndValidateShiftInfoDateParam(HttpServletRequest request, 
            String name) throws ParseException {
        Date value = null;
    ...
    public static Shift convertAndValidateShift(HttpServletRequest request, 
    ...
    public static SlideType convertAndValidateSlideType(
            HttpServletRequest request, String name) {
    ...
    public static List<BtaRecord> convertAndValidateBtaRecordParams(HttpServletRequest request, BtaShiftInfoSlide slide) {
        ...
        while((row = request.getParameterValues("bta[" + i + "][]")) != null) {
            ...
            if(i > MAX_ROWS) {
                throw new IllegalArgumentException("You may not save more than " + MAX_ROWS + " rows of BTA.");
            }            
            
            if(row.length != 5) {
                throw new IllegalArgumentException("Each BTA record must contain five fields; found: " + row.length);
            }            
    ...
    public static List<BeamToHallRecord> convertAndValidateBeamToHallRecordParams(HttpServletRequest request, PdBeamAccSlide slide) {
        ...
        while((row = request.getParameterValues("beam[" + i + "][]")) != null) {
            ...
            if(i > MAX_ROWS) {
                throw new IllegalArgumentException("You may not save more than " + MAX_ROWS + " rows of Beam-To-Hall.");
            }            
            
            if(row.length != 6) {
                throw new IllegalArgumentException("Each Beam-To-Hall record must contain six fields; found: " + row.length);
            }            
    ...
    public static List<AccActivityRecord> convertAndValidateAccActivityRecordParams(HttpServletRequest request, PdBeamAccSlide slide) {
        ...
        while((row = request.getParameterValues("activity[" + i + "][]")) != null) {
            ...
            if(i > MAX_ROWS) {
                throw new IllegalArgumentException("You may not save more than " + MAX_ROWS + " rows of Accelerator Activity.");
            }            
            
            if(row.length != 3) {
                throw new IllegalArgumentException("Each Accelerator Activity record must contain three fields; found: " + row.length);
            }            
    ...
    public static List<AccessRecord> convertAndValidateAccessRecordParams(HttpServletRequest request, PdAccessSlide slide) {
        ...
        while((row = request.getParameterValues("access[" + i + "][]")) != null) {
            ...
            if(i > MAX_ROWS) {
                throw new IllegalArgumentException("You may not save more than " + MAX_ROWS + " rows of access records.");
            }            
            
            if(row.length != 6) {
                throw new IllegalArgumentException("Each access record must contain six fields; found: " + row.length);
            }            
