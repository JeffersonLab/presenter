            ...
            case TITLE_BODY_SLIDE:
                ...
                switch (titleBodySlideType) {
                    ...
                    case SINGLE_COLUMN:
                        ...
                        break;
                    default:
                        throw new IllegalArgumentException("TitleBodySlideType not recognized: " + titleBodySlideType);
                }
                break;
            case BODY_SLIDE:
            ...
            case PD_INFO_SLIDE:
                ...
                switch (pdInfoSlideType) {
                    ...
                    case SECOND_SUMMARY:
                        ...
                        break;
                    default:
                        throw new IllegalArgumentException("PdInfoSlideType not recognized: " + pdInfoSlideType);
                }
                break;
