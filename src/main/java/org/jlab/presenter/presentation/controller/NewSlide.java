...
@WebServlet(
    name = "NewSlide",
    urlPatterns = {"/new-slide"})
public class NewSlide extends HttpServlet {

  private static final Logger LOGGER = Logger.getLogger(NewSlide.class.getName());
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (errorReason == null) {
      try {
        ...
        SlideType type = ConvertAndValidateUtil.convertAndValidateSlideType(request, "slideType");
        ...
        errorReason = "Unable to create new slide; presentationId must be " + "a number";
      } catch (Exception e) {
        LOGGER.log(Level.SEVERE, "Unable to create new slide", e);
