 ...
 * @author ryans
 */
@WebServlet(name = "ImportShiftLogs", urlPatterns = {"/import-shift-logs"})
public class ImportShiftLogs extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        BigInteger precedingDayCountBig = ConvertAndValidateUtil.convertAndValidateBigIntegerParam(
                request, "preceding-day-count");
        ...
        if (precedingDayCountBig == null) { // Just use default
            ...
            if (!presentationFacade.isAuthorized(
                    PresentationType.PD_PRESENTATION)) {
                throw new IllegalArgumentException(
                        "Login as PD to select / refresh shift logs");
            }
        }
