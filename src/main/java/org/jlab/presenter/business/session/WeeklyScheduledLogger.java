...
public class WeeklyScheduledLogger {
  ...
  private static final Logger logger = Logger.getLogger(WeeklyScheduledLogger.class.getName());
  ...
  private void send130Elog() {
    ...
    PDPresentationType[] typeArray = {
      PDPresentationType.SUM3, PDPresentationType.SUM2, PDPresentationType.SUM1
    };
      ...
      if (presentationId != null) {
        ...
        try {
          ...
          if (response.contains("Error")) {
            logger.log(
                Level.WARNING,
                "Unable to automatically create 1:30 presentation log entry: {0}",
                response);
          }
          ...
          logger.log(
              Level.WARNING, "Unable to automatically create 1:30 presentation log entry", e);
        }
